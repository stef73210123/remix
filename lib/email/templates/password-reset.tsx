...
export function PasswordResetEmail({ name, resetUrl }: PasswordResetEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Reset your Circular password — link expires in 15 minutes</Preview>
      <Body style={{ backgroundColor: '#f9fafb', fontFamily: 'sans-serif' }}>
        <Container style={{ maxWidth: '560px', margin: '40px auto', padding: '40px', backgroundColor: '#ffffff', borderRadius: '8px' }}>
          <Heading style={{ fontSize: '24px', color: '#111827', marginBottom: '8px' }}>
            Reset your Circular password
          </Heading>
          <Text style={{ color: '#6b7280', marginBottom: '32px' }}>
            Hi {name}, click the button below to reset your password. This link expires in 15 minutes.
          </Text>
