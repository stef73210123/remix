...
export default function CoordinateDisplay() {
  ...
  return (
    <div className="hidden sm:block absolute bottom-[calc(88px_+_env(safe-area-inset-bottom))] right-2 z-20 bg-[#161616]/80 backdrop-blur-sm rounded px-2 py-1 text-[10px] text-white/70 font-mono">
