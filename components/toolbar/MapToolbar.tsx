...
export default function MapToolbar() {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center gap-1 bg-[#161616]/90 backdrop-blur-sm rounded-lg px-2 py-1.5 shadow-lg border border-white/10">
      <ToolbarButton
